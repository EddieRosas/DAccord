...
class ChannelsIndexFooterBar extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const userIcon = this.props.currentUser ? this.props.currentUser.imageUrl : null;

        return (
            <section id="channels-index-footer-bar">
                <div id="channels-index-footer-bar-content">
                    <button id="user-name-icon-button" onClick={this.handleImageClick}>
                        <div className="tooltip">Edit Icon</div>
                        <img src={userIcon} id="user-name-icon" />
                    </button>
                    <div id="user-name-box">
                        <div id="channels-index-footer-bar-username">{username}</div>
                    </div>
                    <button id="user-logout-button-button" onClick={this.handleClick}>
                        <div className="tooltip">Log Out</div>
                        <svg id="user-logout-button-image" 
                            height="512pt" 
...
export default ChannelsIndexFooterBar;